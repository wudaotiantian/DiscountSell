...
public class ThirdFragment extends Fragment {
    ...
    private void initView() {
        //TabLayout
        mTabLayout = (TabLayout) view.findViewById(R.id.tab_free_post2);
        //ViewPager
        mViewPager = (ViewPager) view.findViewById(R.id.vp_free_post2);
        //初始化相对布局
        relativeLayout = (RelativeLayout) view.findViewById(R.id.rl_title2);
        //初始化标题的按钮
        mImageView = (ImageView) view.findViewById(R.id.iv_recommend_title2);
    }
    /**
     * 创建适配器
     */
